...
('Billing System Core', 'BILL-001', 1, 'Financial Operations', 'FIN-001', 'Critical', 'Production', 'Enterprise Application', 'Microservices', 'Cloud Native', NULL, NULL, 'Front Office', 'SYS-BILL-001', 'Tier 1', 'John Smith', 'Sarah Wilson', 'JS001', 'SW002', 'AWS EKS'),
('Financial Core Platform', 'FIN-CORE', 1, 'Financial Operations', 'FIN-001', 'Critical', 'Production', 'Platform', 'Service Mesh', 'Hybrid Cloud', 'Billing System Core', 'BILL-001', 'Back Office', 'SYS-FIN-CORE', 'Tier 1', 'John Smith', 'Michael Davis', 'JS001', 'MD003', 'AWS + On-Premise'),
('Customer Relationship Management', 'CRM-002', 1, 'Sales Operations', 'SALES-001', 'High', 'Production', 'Business Application', 'Monolithic', 'Cloud', NULL, NULL, 'Front Office', 'SYS-CRM-002', 'Tier 2', 'Alice Johnson', 'Robert Brown', 'AJ004', 'RB005', 'Azure Cloud'),
('Sales Application Suite', 'SALES-APP', 1, 'Sales Operations', 'SALES-001', 'Medium', 'Production', 'Application Suite', 'SOA', 'Cloud', 'Customer Relationship Management', 'CRM-002', 'Front Office', 'SYS-SALES-APP', 'Tier 2', 'Alice Johnson', 'Emily Taylor', 'AJ004', 'ET006', 'Azure App Service'),
('Logistics Management System', 'LOG-003', 0, 'Operations', 'OPS-001', 'Low', 'Decommissioned', 'Legacy Application', 'Monolithic', 'On-Premise', NULL, NULL, 'Back Office', 'SYS-LOG-003', 'Tier 3', 'David Miller', 'Lisa Anderson', 'DM007', 'LA008', 'On-Premise Data Center');

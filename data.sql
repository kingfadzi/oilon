...
INSERT INTO spdw_vwsfbusinessapplication (business_application_name, correlation_id, active, owning_transaction_cycle, owning_transaction_cycle_id, resilience_category, operational_status, application_type, architecture_type, install_type, application_parent, application_parent_correlation_id, house_position, cease_date, business_application_sys_id, application_tier, application_product_owner, system_architect, application_product_owner_brid, system_architect_brid, architecture_hosting) VALUES
('Billing System Core', 'BILL-001', true, 'Financial Operations', 'FIN-001', 'Critical', 'Production', 'Enterprise Application', 'Microservices', 'Cloud Native', NULL, NULL, 'Front Office', NULL, 'SYS-BILL-001', 'Tier 1', 'John Smith', 'Sarah Wilson', 'JS001', 'SW002', 'AWS EKS'),
('Financial Core Platform', 'FIN-CORE', true, 'Financial Operations', 'FIN-001', 'Critical', 'Production', 'Platform', 'Service Mesh', 'Hybrid Cloud', 'Billing System Core', 'BILL-001', 'Back Office', NULL, 'SYS-FIN-CORE', 'Tier 1', 'John Smith', 'Michael Davis', 'JS001', 'MD003', 'AWS + On-Premise'),
('Customer Relationship Management', 'CRM-002', true, 'Sales Operations', 'SALES-001', 'High', 'Production', 'Business Application', 'Monolithic', 'Cloud', NULL, NULL, 'Front Office', NULL, 'SYS-CRM-002', 'Tier 2', 'Alice Johnson', 'Robert Brown', 'AJ004', 'RB005', 'Azure Cloud'),
('Sales Application Suite', 'SALES-APP', true, 'Sales Operations', 'SALES-001', 'Medium', 'Production', 'Application Suite', 'SOA', 'Cloud', 'Customer Relationship Management', 'CRM-002', 'Front Office', NULL, 'SYS-SALES-APP', 'Tier 2', 'Alice Johnson', 'Emily Taylor', 'AJ004', 'ET006', 'Azure App Service'),
('Logistics Management System', 'LOG-003', false, 'Operations', 'OPS-001', 'Low', 'Decommissioned', 'Legacy Application', 'Monolithic', 'On-Premise', NULL, NULL, 'Back Office', '2024-12-31', 'SYS-LOG-003', 'Tier 3', 'David Miller', 'Lisa Anderson', 'DM007', 'LA008', 'On-Premise Data Center');
